...
//keys for animatedlists
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButtonLocation: showFab? FloatingActionButtonLocation.centerDocked : FloatingActionButtonLocation.centerTop,
      ...
      width:  MediaQuery.of(context).size.width/2,
       child: AnimatedList(
          ...
          itemBuilder: (context, index,animation){
            IconData icon = isLeft? horizontalCircleIconsLeft[index]:horizontalCircleIconsRight[index];
              ...
              setState(() {
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: animation.value==0? Colors.grey.shade300: (selected?selectedColor : Colors.grey.shade700),
                  ),
                ),
              ),
    //label              
              AnimatedContainer(
                ...
                child: AnimatedOpacity(
                  ...
                  duration: duration,
                  child: Txt(
                    text: isLeft? horizontalCircleLabelsisLeft[index]:horizontalCircleLabelsisRight[index],
                    color: Colors.white,
                    textAlign: TextAlign.center,
                  ),
                ),
  ...
  Widget bottomNavigationBar(){
    return BottomAppBar(
      ...
      items: [
        ...
        BottomNavigationBarItem(icon: Icon(Icons.signal_cellular_alt_outlined),label: "Analytics"),
      ],      
    )
    );
  }
