...
static List<GResult> total = [
      GResult("https://gihub.com>om-chauhan","om-chauhan/google-search-clone...-Github", "25-Mar-2021 - A Google Search Clone using flutter (Mobile, Tablet, Desktop version), getting started. 1.copy or download code in your project"),
      GResult("https://gihub.com>flutter>flutter","flutter/flutter: Flutter makes it easy and fast to build beautiful ...- Github",null),
      GResult("https://gihub.com>tortuvshin>op...","Github - tortuvshin/open-source-flutter-apps", "The amin goal of this repository is to find free open source apps and start contributing to it. Feel free to contribute to the list, any suggestions are welcome."),
      GResult("https://gihub.com>tortuvshin>op...","Github - tortuvshin/open-source-flutter-apps", "The amin goal of this repository is to find free open source apps and start contributing to it. Feel free to contribute to the list, any suggestions are welcome."),
      GResult("https://gihub.com>tortuvshin>op...","Github - tortuvshin/open-source-flutter-apps", "The amin goal of this repository is to find free open source apps and start contributing to it. Feel free to contribute to the list, any suggestions are welcome."),
      GResult("https://gihub.com>om-chauhan","om-chauhan/google-search-clone...-Github", "25-Mar-2021 - A Google Search Clone using flutter (Mobile, Tablet, Desktop version), getting started. 1.copy or download code in your project"),
      GResult("https://gihub.com>om-chauhan","om-chauhan/google-search-clone...-Github", "25-Mar-2021 - A Google Search Clone using flutter (Mobile, Tablet, Desktop version), getting started. 1.copy or download code in your project"),
 ...
 static List<String> languages = [
   "English", "हिन्दी", "தமிழ்",  "বাংলা", "తెలుగు", "मराठी", "ગુજરાતી", "ಕನ್ನಡ", "മലയാളം", "ਪੰਜਾਬੀ",
 ];
}