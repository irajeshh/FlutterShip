...
class _CurrenciesPageState extends State<CurrenciesPage> {
 ...
 static List<Currency> currencies = [
    Currency("Gemini Dollar (GUSD)", "\$7,312.00", 0.21, true, Icons.all_inclusive_outlined, Colors.cyan),
    Currency("Basic Attention Token", "\$1,411.00", 0.11, false, Icons.change_history_outlined, Colors.pink),
    Currency("Bitcoin (BTC)", "\$9,299.00", 0.51, false, Icons.monetization_on_outlined, Colors.yellow),
    Currency("Basic Attention Token", "\$1,411.00", 0.11, false, Icons.change_history_outlined, Colors.pink),
    Currency("Bitcoin (BTC)", "\$9,299.00", 0.51, false, Icons.monetization_on_outlined, Colors.yellow),
    Currency("Bitcoin (BTC)", "\$9,299.00", 0.51, false, Icons.monetization_on_outlined, Colors.yellow),
    Currency("Basic Attention Token", "\$1,411.00", 0.11, false, Icons.change_history_outlined, Colors.pink),
