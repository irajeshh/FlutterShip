        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(Icons.brightness_1,size:8,color:selected?Colors.red:Colors.transparent),
              height: 15,
              width: width - 35,
            ),
  ...
  Widget ywmdRow(){
    return Row(
      children: ywmdList.map((ywmd){
        ...
        switch (index) {
          case 0: br = BorderRadius.only(topLeft: corner,bottomLeft: corner);
          break;

          case 3:br = BorderRadius.only(topRight: corner,bottomRight: corner);
          break;
  ...
  Widget staggaredColorGrid(){
   return Expanded(
     child: StaggeredGridView.countBuilder(
        ...
        itemBuilder: (context, int index){
          InterlacedEvent event = events[index];
...
static List<InterlacedEvent> events = [
      ...
      InterlacedEvent(Colors.deepOrange, "The Amazing Hubble", "11:00",null,Urls.avatar3,Urls.avatar2),
      InterlacedEvent(Colorz.interlacedChatPurple,"Choosing A Quality Cookware Set", "13:00","15:00",Urls.avatar1,Urls.avatar3),
      InterlacedEvent(Colors.pink, "Astronomy Binoculars A Great Alternative", "15:00","17:59",Urls.avatar3,Urls.avatar1),
