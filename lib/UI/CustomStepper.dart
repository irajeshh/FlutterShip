...
class _StepperExampleState extends State<StepperExample> {
  ...
  static  List<CustomStep> steps = [
          CustomStep(DateTime(2021,8,9,9,30).millisecondsSinceEpoch, "Order Placed", "Your order #212423 was placed for delivery"),
          CustomStep( DateTime(2021,8,9,9,35).millisecondsSinceEpoch, "Pending", "Your order is pending for confirmation. Wil confirmed within 5 minutes"),
          CustomStep(DateTime(2021,8,9,9,55).millisecondsSinceEpoch, "Confirmed", "Your order is confirmed. Will deliver soon within 20 minutes."),
